...
import { class_type, unit_type, MethodInfo, union_type, list_type, option_type, record_type, string_type, int32_type } from "./fable_modules/fable-library.3.6.3/Reflection.js";
import { cons, length as length_1, filter, empty } from "./fable_modules/fable-library.3.6.3/List.js";
import { Cmd_none } from "./fable_modules/Fable.Elmish.3.1.0/cmd.fs.js";
import { equals } from "./fable_modules/fable-library.3.6.3/Util.js";
import { map, defaultArg } from "./fable_modules/fable-library.3.6.3/Option.js";
import { reverse, length } from "./fable_modules/fable-library.3.6.3/Seq.js";
import { Browser_Types_EventTarget__EventTarget_get_Value, LitHelpers_html } from "./fable_modules/Fable.Lit.1.3.1/Lit.fs.js";
...
import { Program_mkHidden, LitElmishExtensions_useElmish } from "./fable_modules/Fable.Lit.Elmish.1.3.0/Lit.Elmish.fs.js";
...
export const Notes = (new HookComponentAttribute()).Decorate(function () {
    const patternInput = LitElmishExtensions_useElmish(Hook_getContext_343DAFF1(this), () => Program_mkHidden(init, (msg, state) => update(msg, state)));
    ...
    <section>
    <ul>
    ${repeat(reverse(state_1.Notes), (item) => (`${item.Id}`), (note, index) => noteTemplate(note, index))}
    </ul>
    </section>
    `);
